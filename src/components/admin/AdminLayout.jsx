...
const NAV_ITEMS = [
  ...
  { label: "Inventory Tracking", href: "/admin/inventory", icon: CheckSquare },
  { label: "Sales Management", href: "/admin/sales", icon: BarChart3 },
  { label: "Discounts & Alerts", href: "/admin/alerts", icon: AlertTriangle },
  { label: "Reports Analytics", href: "/admin/reports", icon: TrendingUp },
